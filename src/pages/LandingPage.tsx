      ...
      <div className="container">
        <div className="nav-inner">
          <button onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })} className="logo" style={{ background: 'none', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.5rem', padding: 0 }}>
            <img src="/icon-192.png" alt="Acadera Logo" className="logo-icon" style={{ background: 'transparent' }} />
            <span>Acadera</span>
          </button>
          ...
          <div className="footer-grid">
            <div className="footer-col">
              <div className="logo footer-logo">
                <img src="/icon-192.png" alt="Logo" className="logo-icon" style={{ background: 'none' }} />
