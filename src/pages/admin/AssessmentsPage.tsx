...
export default function AssessmentsPage() {
  ...
  return (
    <div style={{ fontFamily: '"DM Sans", sans-serif', animation: '_fadeIn 0.5s ease' }}>
      ...
      {/* Controls Card */}
      <div style={{ background: 'var(--bg-card)', borderRadius: 8, padding: 24, border: `1.5px solid ${T.border}`, marginBottom: 24, boxShadow: '0 1px 3px rgba(0,0,0,0.02)' }}>
      ...
      {!selectedClass || !selectedSubject ? (
        <div style={{ height: 400, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: 'var(--bg-card)', borderRadius: 12, border: `1.5px solid ${T.border}` }}>
        ...
        <div style={{ background: 'var(--bg-card)', borderRadius: 12, border: `1.5px solid ${T.border}`, overflow: 'hidden', boxShadow: '0 4px 20px rgba(0,0,0,0.03)', animation: '_slideUp 0.4s ease' }}>
      ...
      >
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, padding: '10px 0' }}>
          <div 
            ...
            style={{ padding: 20, background: 'var(--bg-card)', border: `1.5px solid ${T.border}`, borderRadius: 8, textAlign: 'center' }}>
