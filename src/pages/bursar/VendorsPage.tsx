  ...
  return (
    <div style={{ fontFamily: '"DM Sans", sans-serif' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 20, marginBottom: 32 }}>
        <div style={{ background: 'var(--bg-card)', padding: 24, borderRadius: 8, border: '1.5px solid #f1f5f9', display: 'flex', alignItems: 'center', gap: 16 }}>
      ...
      {/* Search & Filter */}
      <div style={{ background: 'var(--bg-card)', padding: '12px 20px', borderRadius: 8, border: '1.5px solid #f1f5f9', marginBottom: 24, display: 'flex', alignItems: 'center', gap: 12 }}>
        ...
        <input 
          ...
          style={{ border: 'none', outline: 'none', width: '100%', fontSize: 14, fontWeight: 600, color: '#334155' }}
        />
      </div>
      ...
      {isLoading ? (
        ...
        <div style={{ padding: 100, textAlign: 'center', background: 'var(--bg-card)', borderRadius: 12, border: '1.5px dashed #e2e8f0' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(320px, 1fr))', gap: 24 }}>
          {filtered.map(v => (
            <div key={v.id} className="v-card" style={{ background: 'var(--bg-card)', borderRadius: 12, padding: 24, position: 'relative', overflow: 'hidden' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20 }}>
                <div style={{ width: 56, height: 56, borderRadius: 8, background: '#f8fafc', border: '1.5px solid #f1f5f9', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 24 }}>
                  🏢
                </div>
