  ...
  if (!activeElection) {
    return (
      <div style={{ padding: 60, textAlign: 'center', background: 'var(--bg-card)', borderRadius: 16, border: '1px solid var(--border-light)', boxShadow: '0 4px 20px rgba(0,0,0,0.04)', animation: '_fadeIn 0.4s ease' }}>
        ...
        <p style={{ color: 'var(--text-muted)', fontSize: 16 }}>There are currently no active prefectorial elections running.</p>
      </div>
    )
  }
  ...
  return (
    <div style={{ paddingBottom: 80, animation: '_fadeIn 0.4s ease' }}>
      ...
      <div className="elections-header" style={{ marginBottom: 32 }}>
        <h1 style={{ fontSize: 24, fontWeight: 700, color: 'var(--text-main)', margin: 0 }}>Student Elections Hub</h1>
        <p style={{ color: 'var(--text-muted)', marginTop: 4, fontSize: 14 }}>{activeElection.title}</p>
      </div>

      <div style={{ display: 'flex', gap: 8, marginBottom: 32, background: 'var(--bg-card)', padding: 8, borderRadius: 12, border: '1px solid var(--border-light)', width: 'fit-content', maxWidth: '100%', overflowX: 'auto' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <div className="vote-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
            <div>
              ...
              <p style={{ fontSize: 13, color: 'var(--text-muted)', margin: '4px 0 0' }}>Mark your preferred candidates and click Submit Ballot.</p>
            </div>
            {activeElection.voting_open && (
              <button 
