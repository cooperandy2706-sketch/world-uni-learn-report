    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'staff-directory', element: lazyPage(() => import('./pages/admin/StaffDirectoryPage')) },
          ...
          { path: 'staff-vault', element: lazyPage(() => import('./pages/admin/StaffVaultPage')) },
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'my-vault', element: lazyPage(() => import('./pages/teacher/TeacherVaultPage')) },
      ...
      },
      {
        ...
        children: [
          ...
          { path: 'acadera-tv', element: lazyPage(() => import('./pages/student/WulaTvPage')) },
