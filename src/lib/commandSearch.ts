...
export const GLOBAL_INTENTS: IntentRule[] = [
  ...
  { keywords: ['bill sheet', 'fee statement', 'print bill', 'student bill sheet', 'generate fee statement', 'parent invoice', 'term statement', 'billing statement', 'official bill', 'fee breakdown'], label: 'Student Bill Sheet', subtitle: 'Finance → Bill Sheet', icon: '🧾', path: '/bursar/bill-sheet', color: '#b45309', roles: ['admin', 'bursar'] },
  { keywords: ['daily fee', 'daily fees', 'feeding fee', 'studies fee', 'daily collection', 'record daily', 'daily register fee', 'feeding register', 'daily rate', 'day fee'], label: 'Daily Fees Collection', subtitle: 'Finance → Daily Fees', icon: '📅', path: '/bursar/daily-fees', color: '#0891b2', roles: ['admin', 'bursar'] },
  { keywords: ['vendor', 'suppliers', 'supplier', 'contractor', 'service provider', 'vendor list', 'school vendors', 'add vendor', 'manage vendor', 'vendor management'], label: 'Vendor Management', subtitle: 'Finance → Vendors', icon: '🏪', path: '/bursar/vendors', color: 'var(--text-main)', roles: ['admin', 'bursar'] },
  { keywords: ['requisition', 'requisitions', 'staff request', 'purchase request', 'fund request', 'request for funds', 'approve requisition', 'pending requests', 'approve request', 'procurement request'], label: 'Requisitions', subtitle: 'Finance → Requisitions', icon: '📋', path: '/bursar/requisitions', color: '#6d28d9', roles: ['admin', 'bursar'] },
  { keywords: ['financial report', 'finance report', 'p&l', 'profit and loss', 'ledger', 'account statement', 'transaction report', 'export finance', 'financial summary report', 'bursar report'], label: 'Financial Reports', subtitle: 'Finance → Reports', icon: '📊', path: '/bursar/reports', color: '#1a56db', roles: ['admin', 'bursar'] },
  { keywords: ['school store', 'store inventory', 'uniform stock', 'textbook stock', 'stationery stock', 'sell item', 'restock', 'inventory management', 'stock level', 'low stock', 'school shop'], label: 'School Store & Inventory', subtitle: 'Finance → Inventory', icon: '🗃️', path: '/bursar/inventory', color: 'var(--text-main)', roles: ['admin', 'bursar'] },
  { keywords: ['bill', 'billing', 'invoice', 'subscription', 'create invoice', 'bill the students', 'new fees', 'term bill', 'school bill'], label: 'Admin Billing', subtitle: 'Operations → Billing', icon: '🧾', path: '/admin/billing', color: '#6d28d9', roles: ['admin'] },
  ...
  { keywords: ['alumni', 'graduate', 'former student', 'old student', 'past student', 'school leaver', 'graduated', 'old pupils'], label: 'Alumni Records', subtitle: 'People → Alumni', icon: '🎓', path: '/admin/alumni', color: 'var(--text-muted)', roles: ['admin'] },
  ...
  // ── Operations & Admin ──
  { keywords: ['settings', 'configure', 'school info', 'edit school', 'logo', 'fees structure', 'academic year', 'term', 'semester', 'preferences', 'setup', 'school profile', 'update school'], label: 'School Settings', subtitle: 'Insights → Settings', icon: '⚙️', path: '/admin/settings', color: 'var(--text-main)', roles: ['admin'] },
  ...
  { keywords: ['asset', 'assets', 'inventory', 'equipment', 'furniture', 'school property', 'stock', 'items', 'store', 'stationery', 'supplies', 'manage stock', 'what is in store', 'broken items'], label: 'Inventory & Assets', subtitle: 'Operations → Assets', icon: '🗄️', path: '/admin/assets', color: 'var(--text-main)', roles: ['admin', 'bursar'] },
  { keywords: ['visitor', 'visit', 'guest', 'reception', 'visitor log', 'sign in guest', 'stranger', 'log book', 'who visited', 'who is at the gate', 'visitor record', 'new visitor', 'check in guest'], label: 'Visitor Management', subtitle: 'Operations → Visitors', icon: '🚪', path: '/security/visitors', color: 'var(--text-muted)', roles: ['admin', 'security'] },
  ...
  { keywords: ['incident', 'security alert', 'theft', 'break in', 'emergency', 'security report', 'incident log', 'emergency sos'], label: 'Security Incidents & SOS', subtitle: 'Security → Incidents', icon: '⚠️', path: '/security/incidents', color: '#dc2626', roles: ['admin', 'security'] },
  ...
  { keywords: ['announcement', 'announcements', 'notice', 'news', 'time-bound notifications', 'scheduled alarms', 'expiring announcements', 'post announcement', 'broadcast', 'school news', 'pop-up alarm'], label: 'Announcements & Alarms', subtitle: 'Operations → Announcements', icon: '📢', path: '/admin/announcements', color: '#10b981', roles: ['admin'] },
  { keywords: ['fleet', 'transport', 'bus', 'vehicles', 'live fleet tracking', 'fleet speed alerts', 'bus speed', 'where is the bus', 'track bus', 'school transport', 'gps tracking', 'bus location'], label: 'Live Fleet Tracking', subtitle: 'Operations → Transport', icon: '🚌', path: '/admin/fleet/live', color: '#f59e0b', roles: ['admin'] },
  { keywords: ['maintenance', 'transport maintenance', 'bus issue', 'report bus issue', 'vehicle repair', 'broken bus', 'fix bus', 'mechanic'], label: 'Transport Maintenance', subtitle: 'Operations → Transport', icon: '🔧', path: '/admin/fleet/live', color: '#64748b', roles: ['admin'] },
]
...
const ADVANCED_INTENTS: IntentRule[] = [
  { keywords: ['backup', 'export data', 'download database', 'save records', 'cloud backup', 'data export'], label: 'Data Backup & Export', subtitle: 'Settings → Maintenance', icon: '💾', path: '/admin/settings', color: 'var(--text-main)', roles: ['admin'] },
  { keywords: ['change password', 'update password', 'security settings', 'lock account', 'privacy settings', 'account security'], label: 'Account Security', subtitle: 'Account → Settings', icon: '🔒', path: '/admin/settings', color: '#ef4444', roles: ['any'] },
  ...
  { keywords: ['scholarship', 'financial aid', 'discount', 'fee reduction', 'free education', 'bursary', 'waiver', 'fee waiver', 'student discount'], label: 'Scholarships & Aid', subtitle: 'Finance → Student Records', icon: '🎗️', path: '/bursar/students', color: '#16a34a', roles: ['admin', 'bursar'] },
...
export function intentToPath(
  ...
  switch (intent) {
    ...
    default:
      return isStaff 
        ? { path: '/admin/teachers', icon: '🔍', color: 'var(--text-muted)', verb: "Find Staff" }
