...
export const GLOBAL_INTENTS: IntentRule[] = [
  ...
  { keywords: ['vendor', 'suppliers', 'supplier', 'contractor', 'service provider', 'vendor list', 'school vendors', 'add vendor', 'manage vendor', 'vendor management'], label: 'Vendor Management', subtitle: 'Finance → Vendors', icon: '🏪', path: '/bursar/vendors', color: '#374151', roles: ['admin', 'bursar'] },
  ...
  { keywords: ['school store', 'store inventory', 'uniform stock', 'textbook stock', 'stationery stock', 'sell item', 'restock', 'inventory management', 'stock level', 'low stock', 'school shop'], label: 'School Store & Inventory', subtitle: 'Finance → Inventory', icon: '🗃️', path: '/bursar/inventory', color: '#374151', roles: ['admin', 'bursar'] },
...
const ADVANCED_INTENTS: IntentRule[] = [
  { keywords: ['backup', 'export data', 'download database', 'save records', 'cloud backup', 'data export'], label: 'Data Backup & Export', subtitle: 'Settings → Maintenance', icon: '💾', path: '/admin/settings', color: '#374151', roles: ['admin'] },
